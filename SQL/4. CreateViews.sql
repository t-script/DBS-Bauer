...
CREATE OR REPLACE VIEW "v_Saatgut" AS
	SELECT
		SAATGUT.PK_Saatgut,
		SAATGUT.Name,
		SAATGUT.Preis,
	...
	FROM
		public.SAATGUT,
		public.SAATGUT_BESTAND,
		public.LAGER
	WHERE
		SAATGUT.PK_SAATGUT = SAATGUT_BESTAND.FK_SAATGUT AND
		SAATGUT_BESTAND.FK_LAGER = LAGER.PK_Lager;

CREATE OR REPLACE VIEW "v_FutterName" AS
	SELECT
		FUTTER.Name,
		PK_Futter
	FROM
...
CREATE OR REPLACE VIEW "v_Stallart" AS
	SELECT
		STALL.Stallart,
		PK_Stall
	FROM
